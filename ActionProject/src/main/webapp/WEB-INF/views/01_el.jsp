...
<body>
	...
	<p>
		...
		<!--
			...
			해당 필드에 네이밍컨벤션에 부합하는 getter를 찾아 호출해줌
		 -->
		수강생의 정보 <br>
			이름 : ${ student.name } <br>
			나이 : ${ student.age } <br>
	...
	<p>없는 키값을 출력하려는 경우</p>
	<p>출력식을 사용함 : &lt;%= num %></p>
	<p>EL구문을 사용함 : ${ werewrewrfds }</p>

	<h3>3. EL 사용시 키값이 동일한 경우</h3>

	key라는 키값에 담긴 밸류 : ${ key } <br>
	...
	<p>
		...
		strOne과 strTwo가 같습니까? : ${ strOne eq strTwo } <br> ${ strOne == strTwo }
