		          ...
		          <div class="form-group">
					...
					<c:choose>
			            <c:when test="${ map.at ne null }">
			            	<!--
			            		localHost:4000/Kh/resources/board_upfiles/KH_academy_20250930171759_577.PNG
			            	 -->
			            	<!-- 첨부파일은 있을수도있음 -->
			            	<a download="${ map.at.originName }" href="${ map.at.filePath }/${ map.at.changeName}">${ map.at.originName }</a><br>
