...
public class Subway {
	...
	public void setSandwich(String sndwich) {
		this.sandwich = sndwich;
	}
	...
	public String toString() {
		return "Subway [name=" + name + ", phone=" + phone + ", address=" + address + ", request=" + request
				+ ", sndwich=" + sandwich + ", vegetable=" + vegetable + ", sauce=" + sauce + ", cookie=" + cookie
				+ ", payment=" + payment + ", orderDate=" + orderDate + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(address, cookie, name, orderDate, payment, phone, request, sauce, sandwich, vegetable);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && Objects.equals(cookie, other.cookie)
				...
				&& Objects.equals(request, other.request) && Objects.equals(sauce, other.sauce)
				&& Objects.equals(sandwich, other.sandwich) && Objects.equals(vegetable, other.vegetable);
	}
